...
const Carousel = () => {
    ...
    const carouselItemsData = [
        ...
        },
        {
            ...
            space_facts: [
                {
                    count: 1957,
                    desc: "1957, launch year of Sputnik 1, the first artificial satellite.h"
                },
                {
                    count: 8000,
    ...
    return(
        ...
        <div className="carousel_container relative bg-secondary-5 w-full h-[300px] sm:h-[400px] md:h-[500px] 
            after:content-[''] after:z-[3] after:absolute after:w-full after:h-full after:bg-gradient-to-r 
            after:from-transparent_dark-9 after:via-transparent_dark-7 after:to-transparent_dark-0 after:top-0 after:left-0">

            <i className="bi bi-caret-left-fill z-[5] text-transparent_light-7 hover:text-transparent_light-2 absolute top-[50%] scale-[1.7] sm:scale-[1.9] md:scale-[2.5] 
                -translate-y-[50%] left-3 sm:left-4 md:left-5"
                onClick={() => {backSlide()}}></i> {/* arrow left */}
            
            <i className="bi bi-caret-right-fill z-[5] text-transparent_light-7 hover:text-transparent_light-2 absolute top-[50%] scale-[1.7] sm:scale-[1.9] md:scale-[2.5] 
            ...
            <div className="dot z-[4] w-max h-max flex gap-1 sm:gap-2 md:gap-4 absolute bottom-3 md:bottom-4 
                ...
                <span className="inline-block w-2 h-2 sm:scale-[1.5] md:scale-[1.8] bg-transparent_light-7 rounded-full cursor-pointer"></span>
                <span className="inline-block w-2 h-2 sm:scale-[1.5] md:scale-[1.8] bg-transparent_light-7 rounded-full cursor-pointer"></span>
                <span className="inline-block w-2 h-2 sm:scale-[1.5] md:scale-[1.8] bg-transparent_light-7 rounded-full cursor-pointer"></span>
            </div> 
